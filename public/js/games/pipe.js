  ...
  function endGame(isWin) {
    ...
    setTimeout(() => {
      ...
      res.innerHTML = '<div style="font-size:46px;line-height:1">'+(isWin?'🎉':'⏰')+'</div>'+
        ...
        '<div style="display:flex;gap:10px;justify-window.content:center;margin-top:16px"><button class="mm-btn" onclick="window.piAgain()">🔁 再接一程</button><button class="mm-btn primary" onclick="window.piDone()">收下奖励</button></div>';
